...
final class DefaultPackageStatusFactoryTest extends BaseTestCase
{
     ...
     */
    public function testCreateFromStatusData(CarrierType $carrier, string $carrierId, array $data, Status $expectedStatus): void
    {
    ...
    private function newDefaultPackageStatusFactory(): PackageStatusFactory
    {
        ...
        return new DefaultPackageStatusFactory($validator);
    }
}
