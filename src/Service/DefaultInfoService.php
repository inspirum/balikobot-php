...
class DefaultInfoService implements InfoService
{
    ...
    {
        $response = $this->client->call(Version::V2V1, null, Request::INFO_WHO_AM_I);
    ...
    {
        $response = $this->client->call(Version::V2V1, null, Request::INFO_CARRIERS);

        return $this->carrierFactory->createCollection($response);
    }

    public function getCarrier(CarrierType $carrier): Carrier
    {
        $response = $this->client->call(Version::V2V1, null, Request::INFO_CARRIERS, path: $carrier->getValue());
    ...
    {
        $response = $this->client->call(Version::V2V1, null, Request::CHANGELOG);
